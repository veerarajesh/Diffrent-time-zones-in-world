...
<h1> DIFFERENT TIME ZONES IN WORLD<h1>

<div class="m2">
<img src="one1.jpg";
</div>
<div class="m1">
<body style="backgroun-color:blue;text-align:center;">
<br><br>
<div class="time">
<span id=ct>Timezone here </span>
</div>
<form name=f1>
<select  class="m3" name=tz onChange=disp_TZ()><br><br><br><br>
< onClick=disp_TZ()><br><br><br><br><br>
</select>
